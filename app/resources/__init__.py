...
from .solicitacao_acesso_resource import SolicitacaoAcessoResource, ListaSolicitacaoAcessoResource, SolicitacaoAcessoStatisticsResource
...
from .notificacao_covid_resource import NotificacaoCovidResource, ListaNotificacaoCovidResource
